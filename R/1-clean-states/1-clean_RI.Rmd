...
- Stop and add these to facility spellings and/or facility data, here: 
...
see_if(nrow(df_mid) == nrow(distinct(df_mid, Name, Date))) ## ok if this is false
...
assert_that(nrow(df_comb) == nrow(distinct(df_comb, Name, Date))) ## this must be true
```
...
Starting on May 14th, UCLA collected both statewide and facility-specific counts. 

Might want to remove Residents.Confirmed for state-wide from that point onwards. 
