...
Designate Kintock Newark as "federal" for name cleaning purposes down the line. 
```{r}
df_mid <- df_mid %>%
  mutate(Jurisdiction = ifelse(Name == "KINTOCK NEWARK", "federal", Jurisdiction))
```
