...
source("0-utilities.R", local = knitr::knit_global())
```
...
base_path <- "~/Desktop/Behind Bars/Massachusetts"
plot_path <- file.path("~/Desktop/Behind Bars/Massachusetts", "plots", state_abbrev)
...
```{r}
# df historical
out_name_1 <- glue('{state_abbrev}-historical-data.csv')
write_csv(df_hist, file.path(base_path, "data", out_name_1))

#df historical final
out_name_2 <- glue('{state_abbrev}-historical-data-final.csv')
write_csv(df_hist_final, file.path(base_path, "data", out_name_2))
