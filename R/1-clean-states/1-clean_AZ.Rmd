...
```{r write csv}
# rename POPULATION --> hifld_pop

write_csv(dat_with_pop, file.path(base_path, "data", "AZ_adult_facility_covid_counts_historical.csv"))
```
