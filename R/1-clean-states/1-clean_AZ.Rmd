...
df_hist_final$Residents.Population <- df_hist$Resident.Population
all_cols <- df_hist_final <- behindbarstools::reorder_cols(df_hist_final, rm_extra_cols = TRUE)
...
```{r plot cases/deaths}
testing <- final_dat
test <- flag_noncumulative_cases(testing, Name)
...
#          path = file.path(base_path, "plots", "AZ", "cases"))
# }
...
#          path = file.path(base_path, "plots", "AZ", "deaths"))
# }
```
