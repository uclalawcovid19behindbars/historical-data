---
title: "Clean North Dakota - COVID-19 Behind Bars Historical Data Cleaning"
...
# filter out unknown facility name 
df_mid <- df_mid %>% 
  filter(Name != "COMMUNITY EXTENDED NUCLEAR TRA MANDAN")
```
...
df_hist_final_edit <- df_hist_final %>%
  mutate(Residents.Confirmed = ifelse(Name == "MISSOURRI RIVER CORRECTIONAL CENTER" & 
                                        Date > as.Date("2020-05-20") & 
                                        Date < as.Date("2020-06-10"),
                                      NA, Residents.Confirmed),
         Staff.Confirmed = ifelse(Name == "NORTH DAKOTA STATE PENITENTIARY" &
                                     Date > as.Date("2020-06-29") & 
                                     Date < as.Date("2020-07-14"),
                                   2, Staff.Confirmed),
          Staff.Confirmed = ifelse(Name == "NORTH DAKOTA STATE PENITENTIARY" &
                        Date > as.Date("2020-07-13") &             
                        Date < as.Date("2020-07-22"), 
                       5, Staff.Confirmed),
         Staff.Confirmed = ifelse(Name == "CENTRAL OFFICE" &
                 Date > as.Date("2020-06-29") & 
                 Date < as.Date("2020-07-22"),
               1, Staff.Confirmed),
         Staff.Confirmed = ifelse(Name == "JAMES RIVER CORRECTIONAL CENTER" &
                 Date > as.Date("2020-06-29") & 
                 Date < as.Date("2020-07-22"),
               1, Staff.Confirmed),
         ) 
