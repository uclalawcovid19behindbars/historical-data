...
```{r}
df_out %<>% 
  mutate(Staff.Deaths = behindbarstools::coalesce_with_warnings(Staff.Deaths, Staff.Death),Resident.Deaths = behindbarstools::coalesce_with_warnings(Resident.Deaths, Resident.Death)) 
```
...
df_mid <- df_mid %>% filter(Name != "COMMUNITY EXTENDED NUCLEAR TRA MANDAN")
```
