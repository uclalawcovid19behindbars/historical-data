...
# WYOMING STATE PENITENTIARY: The original source reports on August 14, 2020 that Residents Cases increased from 15 to 29 Residents Cases (active and recovered combined), while the Excel Sheet reports only 15 Residents Cases on 2020-08-14. The Excel Sheet consistently reported 15 Residents Cases for every date passed 2020-08-14 (with the exception of the negative lag cases) until 2020-11-04 even though the original source reported that Residents Cases were increasing. On 2020-11-04, the Excel sheet reports there is 103 Residents Confirmed. However, the original source there were already 103 Residents Confirmed on September 18, 2020, and the Excel Sheet reported only 15 Residents Confirmed on 2020-09-18.
```
...
```{r Date Span Notes}
# From 2020-08-20 to 2020-11-04, the instances fluctuate up and down between 5 and 6 instances.
```
...
```{r Comparison Notes}
# Residents Confirmed
# 2020-08-18: 15 (cbb) vs. 92 (mpap)
# 2020-08-27: 92 (cbb) vs. 101 (mpap)
# 2020-09-02: 15 (cbb) vs. 105 (mpap)
# 2020-09-08: 15 (cbb) vs. 105 (mpap)
# 2020-09-15: 15 (cbb) vs. 107 (mpap)
# 2020-09-25: 15 (cbb) vs. 107 (mpap)
# 2020-10-08: 15 (cbb) vs. 108 (mpap)
# Residents Confirmed (cbb) has issues with negative lag cases from 2020-08-20 to 2020-08-21, 2020-08-23 to 2020-08-30, and 2020-09-01 to 2020-09-02 (mentioned above in Cases Notes). 
# There is consistently 15 Residents Confirmed (cbb) reported for 2020-08-14 and forward (with the exception of the negative lag cases) until 2020-11-04 even though we know the original source reported that Residents Confirmed were increasing (same issue as above).
# Residents Recovered
# 2020-08-27: 24 (cbb) vs. 90 (mpap)
# 2020-09-08: 0 (cbb) vs. 103 (mpap)
# 2020-09-15: 0 (cbb) vs. 103 (mpap)
# 2020-09-25: 0 (cbb) vs. 107 (mpap)
# 2020-10-20: 0 (cbb) vs. 108 (mpap)
# Residents Recovered (cbb) has issues with negative lag cases from 2020-08-20 to 2020-08-21, 2020-08-23 to 2020-08-30, and 2020-09-01 to 2020-09-02.
# There is consistently 0 Residents Recovered (cbb) reported for 2020-08-14 and forward (with the exception of the negative lag cases) until 2020-11-04 even though we know the original source reported that Residents Recovered were increasing.
```
