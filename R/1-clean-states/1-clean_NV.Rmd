---
title: "Clean Nevada - COVID-19 Behind Bars Historical Data Cleaning"
author: "Hope Johnson"
date: "4/02/21"
...
Starting in July 2020, MP cumulative infection counts among incarcerated population were consistently higher than CBB counts (~10).
...
Make the changes that need to happen from facility-level vetting!

```{r}
df_hist_final_edit <- df_hist_final %>%
  mutate(Staff.Confirmed = ifelse(Name == "INDIAN SPRINGS SOUTHERN TRAINING CENTER" & 
                                  Date == as.Date("2020-06-26"),
                                  8, Staff.Confirmed),
         Staff.Confirmed = ifelse(Name == "LOVELOCK CORRECTIONAL CENTER" & 
                                  Date == as.Date("2020-06-26"),
                                  13, Staff.Confirmed)
         )
