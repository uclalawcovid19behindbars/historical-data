---
title: "data cleaning south dakota"
author: "Kevin Zhao"
date: "5/28/2021"
output: pdf_document
---
...
base_path <- file.path("C:/Users/User/Documents/UCLA/UCLA Law Covid")
data_path <- file.path(base_path)
##Load utilities function
util_path <- file.path("C:\\Users\\User\\Documents\\UCLA\\UCLA Law Covid\\0-utilities.R")
...
df_out <- df_out %>% mutate(Resident.Deaths = behindbarstools::coalesce_with_warnings(Resident.Deaths, Resident.Death))
df_out <- df_out %>% mutate(Resident.Deaths = behindbarstools::coalesce_with_warnings(Resident.Deaths, Residents.Deaths))
```
