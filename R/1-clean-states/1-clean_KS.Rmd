---
title: "Clean Kansas - COVID-19 Behind Bars Historical Data Cleaning"
author: "Hope Johnson"
date: "3/18/21"
...
```{r}
facs_with_october_drops <- c("EL DORADO CORRECTIONAL FACILITY",
...
df_hist_final <- df_hist_final %>%
  mutate(Residents.Confirmed = ifelse((Name %in% facs_with_october_drops) & 
                                      (Date >= as.Date("2020-10-07") & Date <= as.Date("2020-10-18")),
                                      NA, 
                                      Residents.Confirmed))
