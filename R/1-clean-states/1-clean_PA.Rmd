...
# clearly some major issues around 12/22 data update! 
...
#          path = file.path(base_path, "plots", "PA", "cases"))
# }
...
# facilities that lost deaths in 12/22 data update:
# Albion, Smithfield
...
#          path = file.path(base_path, "plots", "PA", "deaths"))
# }
```
...
write_csv(out, file.path(base_path, "data", "PA-historical-data.csv"))
```