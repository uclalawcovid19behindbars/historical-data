---
title: "Clean Hawaii - COVID-19 Behind Bars Historical Data Cleaning"
author: "Hope Johnson"
date: "4/05/21"
...
df_hist_final <- df_hist_final %>%
  ## scraper data is better for these days
  filter(Date != as.Date("2020-10-01"),
         Date != as.Date("2020-10-14"),
         Date != as.Date("2020-10-20")) %>% 
  mutate(Residents.Tested <- NA)
```
