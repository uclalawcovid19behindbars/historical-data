---
title: "Clean Iowa - COVID-19 Behind Bars Historical Data Cleaning"
author: "Kayla Teng"
date: "4/19/21"
...
for (i in 1:nrow(lag_case_plots)){
  ...
  ggsave(paste0(facility_name, "LagChangeCases-IA.png"), lag_case_plots$plot[[i]],
...
# Residents Confirmed = Inmates Recovered + Inmates Recovered, while Residents Recovered = only Inmates Recovered
# Polk County Jail: plot often goes positive to negative; not sure if they are recording cumulative COVID-19 cases per day or total cumulative cases OR inmates who tested positive are being transferred/released from jail
# Clarinda Correctional Facility: negative lag cases 10/23-10/24 but not problematic
# Fort Dodge Correctional Facility: negative lag cases on 7/18-7/29 & 7/21-7/25, but always followed by significant increase in cases on 7/20 and 7/26 respectively.
# Iowa Medical and Classification Center: negative lag cases 7/24-7/25 but not problematic
# DOC: Resident deaths reported starting 7/31 (explains why deaths were not plotted beforehand)
# Polk County Jail: No resident deaths reported at all
```
