---
title: "Clean Georgia - COVID-19 Behind Bars Historical Data Cleaning"
author: "Hope Johnson"
date: "3/3/21"
...
all_deaths <- testing_deaths %>%
  ...
  ggplot(data = ., 
    ...
    labs(x = "Date",
      y = "lag_change_deaths")
## Missed death data from 9/23 - 10/12
## Later, should come back and re-scrape this is possible
## src: http://www.dcor.state.ga.us/content/CVD_Dashboard 
ggplotly(all_deaths)
...
df_hist_final_edit <- df_hist_final %>%
  ...
  mutate(Residents.Confirmed = ifelse(Date == as.Date("2020-06-17") & Name == "COFFEE CORRECTIONAL FACILITY",
                                      6, Residents.Confirmed),
         Residents.Confirmed = ifelse(Date == as.Date("2020-11-04") & Name == "RICHMOND COUNTY CORRECTIONAL INSTITUTION",
