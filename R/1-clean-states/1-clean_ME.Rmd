...
# For STATEWIDE ADULT, there are supposed to be 4 Residents Confirmed on 2020-10-16, but Excel sheet reports NA on 2020-10-18 which is not accurate. STATEWIDE ADULT in Excel sheet only reports 0 or NA for Residents Confirmed.
...
Do some minor data filters based on misscrapes:
...
df_hist_final_edit <- df_hist_final %>%
  filter(Date != as.Date("2020-08-19"),
