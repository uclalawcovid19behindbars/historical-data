---
title: "Clean Utah - COVID-19 Behind Bars Historical Data Cleaning"
...
ggplot(data = dates, 
  ...
  labs(x = "Date",
    y = "n instances")
```
Small spot fixes based on data irregularities with raw data: 

```{r}
df_hist_final_edit <- df_hist_final %>%
  filter(!(Date == as.Date("2020-09-16") & Name == "UTAH STATE PRISON DRAPER"))

## Staff.Confirmed also seems to have issues, unfixed
```
