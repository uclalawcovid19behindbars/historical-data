...
author: "Hope Johnson and Dara Tan"
date: "4/01/21"
...
```{r DARA}
unusual_names <- c("TESTS BY COMMUNITY HEALTH PROVIDERS", "WORKSITE",
                   "FIELD SERVICESS", "AL OTHER STAFF WORKSITES")
df_mid %>%
  filter(scrape_name_clean %in% unusual_names) %>%
  group_by(scrape_name_clean) %>%
  summarize(count = n(),
            n_cases = sum_na_rm(Residents.Confirmed))
...
# DARA: DATES WITH DECREASES IN COUNTS

- 2020-08-23: 7 (22) -> 5	(23) -> 7 (24)
- 2020-08-28 and 2020-08-29:	7 (27) -> 6 (28, 29) -> 7 (30)
...
# DARA: REMOVED STAFF RECOVERED VARIABLE SINCE ALL NA IN df_hist
...
# DARA: ADDED IN FILTER FOR DATE SINCE CBB DATA STOPS ON NOV 4, 2020
...
# DARA: NO PROBLEMATIC DIFFERENCES 
