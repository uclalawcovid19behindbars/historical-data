---
title: "Clean Montana - COVID-19 Behind Bars Historical Data Cleaning"
author: "Kayla Teng"
date: "7/30/21"
...
```{r Cases Notes}
# Notes in Google Doc: https://docs.google.com/document/d/1mhF-BdCr9iYn0EsKD2QJjIYkmprozfY9qIEPZhbcjOE/edit?usp=sharing
```

# Nothing unusual about death plots because there were 0 deaths reported on raw source
...
```{r Date Span Notes}
# On 2020-07-11, there were 22 instances. On 2020-07-12, instances went down to 21 instances.
# On 2020-07-24, there was a decrease to 18 instances.
# On 2020-08-17, there were 8 instances (a decrease). On 2020-08-18, there was an increase to 9 instances. Instances begin increasing again.
```
...
```{r Comparison Notes}
# Residents Confirmed (cbb) keeps fluctuating up and down until 2020-10-28. The values are very strange.
# Residents Confirmed - 2020-10-26: 115 (cbb) vs. 661 (mpap)
```
