...
devtools::install_github("uclalawcovid19behindbars/behindbarstools", force = TRUE)
```
...
```{r write csv}
write_csv(all_dat, file.path(base_path, "data", "florida_adult_facility_covid_counts_historical.csv"))
```
