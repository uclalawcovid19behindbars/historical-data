...
df_mid <- df_mid %>%
  filter(!(Name == "NULL" & (date >= as.Date("2020-07-08") & date <= as.Date("2020-07-11"))))
```
...
```{r write csv}
write_csv(final_dat, file.path(base_path, "data", "florida_adult_facility_covid_counts_historical.csv"))
```
