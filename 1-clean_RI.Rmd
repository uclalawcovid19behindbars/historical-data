---
title: "Clean Rhode Island - COVID-19 Behind Bars Historical Data Cleaning"
author: "Kayla Teng"
date: "6/10/21"
...
```
```{r Plot Notes}
# Original data source were Facebook posts from the Rhode Island Department of Corrections (Checked Perma.cc and Facebook)
# No data from Facebook about Donald W Wyatt Detention Facility.
# No data about Resident and Staff Deaths reported from original source until 2020-09-28.

# Cases
# STATEWIDE: On 2020-04-07, there were two staff that test positive. However, on 2020-04-08, the Excel sheet reports 0 staff confirmed cases even though there are positive COVID-19 cases. Staff confirmed remains 0 until 2020-05-26.
# MINIMUM SECURITY FACILITY: On 2020-05-14, original data source says there are 3 residents confirmed cases, but Excel sheet reports 0 resident confirmed.
# From 2020-05-26 to 2020-11-04, Resident Confirmed in Excel reports NA values even though original data source reports positive COVID-19 cases (CRANSTON ADULT WOMENS, INTAKE SERVICE CENTER, MEDIUM SECURITY FACILITY, MINIMUM SECURITY FACILITY).
# From 2020-05-30 to 2020-11-04, Staff Confirmed in Excel reports NA values even though original data source reports positive COVID-19 cases (CRANSTON ADULT WOMENS, INTAKE SERVICE CENTER, MEDIUM SECURITY FACILITY, MINIMUM SECURITY FACILITY).
# Original data source stops reporting data from 2020-07-30 to 2020-09-28.
# STATEWIDE: Do not know where Residents Recovered and Staff Recovered numbers come from because original data source does not report them.
```
...
```{r Date Span Notes}
# From 2020-08-29 to 2020-11-04, counts fluctuate up and down between 6 and 7 instances.
```
...
```{r Comparison Notes}
# Residents Confirmed
# 2020-05-20: 45 (cbb) vs. 7 (mpap)
# 2020-05-28: 45 (cbb) vs. 11 (mpap)
# 2020-06-01: 46 (cbb) vs. 15 (mpap)
# 2020-06-10: 48 (cbb) vs. 16 (mpap)
# 2020-06-18: 48 (cbb) vs. 17 (mpap)
# 2020-06-23: 49 (cbb) vs. 18 (mpap)
# 2020-06-29: 49 (cbb) vs. 18 (mpap)
# 2020-07-09: 49 (cbb) vs. 20 (mpap)
# 2020-07-14: 49 (cbb) vs. 21 (mpap)
# 2020-07-23: 56 (cbb) vs. 21 (mpap)
# 2020-07-28: 56 (cbb) vs. 22 (mpap)
# 2020-08-04: 56 (cbb) vs. 25 (mpap)
# 2020-08-11: 56 (cbb) vs. 26 (mpap)
# 2020-08-18: 56 (cbb) vs. 29 (mpap)
# 2020-08-25: 56 (cbb) vs. 33 (mpap)
# 2020-09-01: 56 (cbb) vs. 33 (mpap)
# 2020-09-08: 56 (cbb) vs. 34 (mpap)
# 2020-09-15: 56 (cbb) vs. 35 (mpap)
```
